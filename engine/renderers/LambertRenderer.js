...
import { Light } from "../../src/customComponents/Light.js";
...
export class LambertRenderer extends BaseRenderer {
  ...
  async initialize() {
    ...
    const codePerFragment = await fetch(
      new URL("lambertPerFragment.wgsl", import.meta.url)
  ...
  render(scene, camera) {
    ...
    const lightAmbiance = vec3.fromValues(...lightComponent.ambientLight);
    ...
    this.device.queue.writeBuffer(lightUniformBuffer, 32, lightAmbiance);
